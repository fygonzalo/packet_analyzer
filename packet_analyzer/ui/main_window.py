...
from PySide2.QtWidgets import QMainWindow, QFileDialog, QAction

import anytree
from anytree import Resolver, RenderTree
...
from packet_analyzer.ui.model.message_list_model import MessageListModel
...
class MainWindow(QMainWindow, Ui_main_window):
    ...
    @Slot(QAction)
    def on_list_view_selector_triggered(self, action):
        if action == self.action_view_message_list:
            self.list_view_stacked.setCurrentWidget(self.message_list_page)
        else:
            self.list_view_stacked.setCurrentWidget(self.network_event_list_page)
